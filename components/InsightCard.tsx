  ...
  return (
    <div className="bg-gray-800 rounded-lg shadow-lg p-6 h-full flex flex-col">
      <div className="flex items-center mb-4">
        ...
        <h3 className="text-xl font-semibold text-gray-100">분석 요약 (Analysis Summary)</h3>
      </div>
      
      <div className="space-y-6 text-gray-300">
        <div>
          <h4 className="font-semibold text-gray-200 mb-2">요약 (Summary)</h4>
          <p className="text-sm leading-relaxed">{insights.summary}</p>
        </div>
        
        <div>
          <h4 className="font-semibold text-gray-200 mb-2">주요 패턴 (Key Patterns)</h4>
        ...
        <div>
          <h4 className="font-semibold text-gray-200 mb-2">제안 사항 (Suggestions)</h4>
          <ul className="space-y-2 list-inside">

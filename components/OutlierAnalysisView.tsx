        ...
        try {
            const apiKey = user.isAdmin ? appSettings.apiKeys.youtube : (user.apiKeyYoutube || appSettings.apiKeys.youtube);
             ...
             const videoTitles = trendingVideos.map(v => ({
                 title: v.name,
                 channelTitle: (v as any).channelName || ''
             }));
                            ...
                            <div>
                                 ...
                                 <div className="bg-gray-800/60 rounded-lg border border-gray-700/50">
                                    <div className="hidden md:grid grid-cols-12 items-center gap-4 px-4 py-3 text-xs font-semibold text-gray-400 border-b border-gray-700/50">
                                        <div className="col-span-4">영상</div>
                                        <div className="col-span-2 text-center">조회수</div>
                                        <div className="col-span-2 text-center">평균 대비</div>
                                        <div className="col-span-2 text-center">시간당 조회수</div>
                                        <div className="col-span-2 text-center">추정 수익</div>
                                    </div>

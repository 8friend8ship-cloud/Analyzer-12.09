...
const workflowSteps = [
    ...
    },
    {
        step: 3,
        features: [
            { id: 'chrome_extension', title: "크롬 확장 프로그램 (Chrome Extension)", description: "유튜브 시청 중 Viewstats 오버레이로 영상별 조회수, 랭킹 등 실시간 데이터 바로 확인", icon: <ChromeExtensionIcon /> },
        ...
        <div className="p-4 md:p-6 lg:p-8">
            <div className="max-w-4xl mx-auto">
                <header className="text-center mb-10">
                    <h1 className="text-3xl font-bold text-white">Viewstats Pro 워크플로우</h1>

...
// @ts-ignore
import { Check, ArrowRight, BarChart2, Lock, Zap, MousePointerClick, X } from 'lucide-react';
      ...
      <section className="py-24 bg-gray-900/50 border-y border-white/5">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-8 rounded-3xl bg-white/5 border border-white/5 hover:border-red-500/30 transition-all">
              <div className="w-14 h-14 bg-red-500/10 rounded-2xl flex items-center justify-center mb-6 mx-auto">
                <BarChart2 className="w-7 h-7 text-red-400" />
              </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 items-start">
            ...
            <div className="p-8 rounded-3xl border border-white/10 bg-white/5 hover:bg-white/10 transition-colors">
              ...
              <ul className="space-y-4 mb-8 text-left text-sm text-gray-300">
                <li className="flex gap-3"><Check className="w-5 h-5 text-gray-500" /> 월 30회 무료 분석</li>
                <li className="flex gap-3"><Check className="w-5 h-5 text-gray-500" /> 기본 데이터 조회</li>
                <li className="flex gap-3"><X className="w-5 h-5 text-gray-700" /> AI 심층 코칭 제외</li>
              </ul>
              <button onClick={handleStart} className="w-full py-4 rounded-xl bg-white/10 hover:bg-white/20 transition font-semibold">무료로 시작하기</button>
            </div>
            ...
            <div className="relative p-8 rounded-3xl border-2 border-blue-500 bg-blue-900/10 transform md:-translate-y-4 shadow-2xl shadow-blue-500/20">
              ...
              <ul className="space-y-4 mb-8 text-left text-sm text-gray-200">
                <li className="flex gap-3"><Check className="w-5 h-5 text-blue-400" /> <strong>무제한</strong> 분석</li>
                <li className="flex gap-3"><Check className="w-5 h-5 text-blue-400" /> <strong>AI 심층 코칭 (Gemini)</strong></li>
                <li className="flex gap-3"><Check className="w-5 h-5 text-blue-400" /> 채널 비교 분석</li>
                <li className="flex gap-3"><Check className="w-5 h-5 text-blue-400" /> 성장 전략 리포트</li>
              </ul>
              <button onClick={handleStart} className="w-full py-4 rounded-xl bg-blue-500 hover:bg-blue-600 transition font-bold text-white shadow-lg shadow-blue-500/30">Pro 시작하기</button>
            </div>
            ...
            <div className="p-8 rounded-3xl border border-white/10 bg-white/5 hover:bg-white/10 transition-colors">
              ...
              <ul className="space-y-4 mb-8 text-left text-sm text-gray-300">
                <li className="flex gap-3"><Check className="w-5 h-5 text-purple-400" /> <strong>Pro 기능 전체 포함</strong></li>
                <li className="flex gap-3"><Check className="w-5 h-5 text-purple-400" /> 상세 시청자 분석</li>
                <li className="flex gap-3"><Check className="w-5 h-5 text-purple-400" /> 우선 고객 지원</li>
              </ul>
              <button onClick={handleStart} className="w-full py-4 rounded-xl bg-white/10 hover:bg-white/20 transition font-semibold">Biz 시작하기</button>
            </div>
          </div>
        </div>
      </section>

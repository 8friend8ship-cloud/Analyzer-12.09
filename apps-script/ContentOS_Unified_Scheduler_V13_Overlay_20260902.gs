...
function contentOsUnionStageV13_(name){
  try{
    ...
    if(name==='runCentralSketchupNightWindowFromFactory'&&typeof runCentralSketchupNightWindowFromFactory==='function')return runCentralSketchupNightWindowFromFactory(false);
